...
import { PaymentStatusReturnCancel } from "../../api/user/userApi";
import { useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";

function UserPaymentFailed() {
    ...
    <div className="w-full h-full bg-blue-gray-500">
      <div className="bg-gray-100 h-screen">
        <div className="bg-white p-6  md:mx-auto">
          <svg
            viewBox="0 0 24 24"
            className="text-red-700 w-16 h-16 mx-auto my-6"
          >
            <path
              fill="currentColor"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 my-2">
              please go to homepage to continue
            </p>
